...
.. list::
  ...
  :esp32c2 or esp32c3 or esp32c5 or esp32c6 or esp32c61: - The MAC address of {IDF_TARGET_NAME} Station is different from that of the {IDF_TARGET_NAME} SoftAP. Please make sure that you do not set the same MAC address for both of them.
...
.. list::
  ...
  :esp32c2 or esp32c3 or esp32c5 or esp32c6 or esp32c61: - The MAC address of {IDF_TARGET_NAME} SoftAP is different from that of the {IDF_TARGET_NAME} station. Please make sure that you do not set the same MAC address for both of them.
